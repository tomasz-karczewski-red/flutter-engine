...
vars = {
  ...
  'dart_revision': '3cc4208a482a84bffcf09ceb8fdd85001cd43e19',
...
deps = {
  'src': 'https://github.com/tomasz-karczewski-red/buildroot.git@lgi-flutter-2.4.0-AGAIN:b146a42afd9845229fa4078609ef81635236a8a8',
  ...
  'src/third_party/dart/third_party/pkg_tested/dart_style':
   Var('dart_git') + '/dart_style.git@9d9dff90d9a2e0793ad2f795f36c2777f720eda0',
     ...
     'packages': [
       {
        ...
        'version': 'gySDhb-EaVBwE_27pBE4_K-ltlkqT7l_afufOb9DP8QC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'rc7UXpK1KD72S0qpYsMfczjKvxZs2h-bthMIFmRkt50C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',

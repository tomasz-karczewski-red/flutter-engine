...
vars = {
  ...
  'skia_revision': '2f5a91c531de1d00ee7d0f7f8f230abc4f46f867',
...
deps = {
  'src': 'https://github.com/tomasz-karczewski-red/buildroot.git@lgi-2.12.2-release:d5f053c98a80131dc41009c854d9dd5fd43ff8aa',
    ...
    'packages': [
      {
        ...
        'version': 'RW7LSJ9ldZQ_UNH4Z1Pp0XWdkCK5oPpSx5liLfhxDOAC'
      }
    ],
    ...
    'packages': [
      {
        ...
        'version': 'pRlhGPqYQoY4vHqzFBmHYO_D41XXqHubR7bNFUaCHmEC'
      }
    ],
     ...
     'packages': [
       {
        ...
        'version': 'a9NOB6sdojut17iwMYcSzIIY2oEB7rH_KficY_ZHbDEC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
